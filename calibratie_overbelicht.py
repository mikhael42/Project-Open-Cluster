...
data_file_i_1 = np.asarray(fits.getdata('1_m44_i_b.fit'), dtype=np.float32)
data_file_g_1 = np.asarray(fits.getdata('1_m44_g_b.fit'), dtype=np.float32)
data_file_r_1 = np.asarray(fits.getdata('1_m44_r_b.fit'), dtype=np.float32)

data_file_i_2 = np.asarray(fits.getdata('2_m44_i_b.fit'), dtype=np.float32)
data_file_g_2 = np.asarray(fits.getdata('2_m44_g_b.fit'), dtype=np.float32)
data_file_r_2 = np.asarray(fits.getdata('2_m44_r_b.fit'), dtype=np.float32)
...
ans_ref_1 = vind_sterren(data_file_i_1, threshold=70000)

ans_ref_2 = vind_sterren(data_file_i_2, threshold=70000)
...
mask_1 = ans_ref_1['peak'] < 8000000
mask_2 = ans_ref_2['peak'] < 8000000
...
ster_nrs_1 = np.array([8, 9]) - 1
ster_nrs_2 = np.array([3, 4]) - 1
...
echte_mag_i_1 = np.array([11.675, 6.686])
echte_mag_g_1 = np.array([12.029, 10.718])
echte_mag_r_1 = np.array([10.928, 7.013 ])

echte_mag_i_2 = np.array([6.745, 11.159])
echte_mag_g_2 = np.array([9.757, 11.357])
echte_mag_r_2 = np.array([9.274, 11.33])
...
# #3 4 (2)
#8 9 (1)
lijst_inst_mag_i_2 = [phot_i_2['mag'][2], phot_i_2['mag'][3]]
lijst_inst_mag_i_1 = [phot_i_1['mag'][7], phot_i_1['mag'][8]]

lijst_inst_mag_g_2 = [phot_g_2['mag'][2], phot_g_2['mag'][3]]
lijst_inst_mag_g_1 = [phot_g_1['mag'][7], phot_g_1['mag'][8]]

lijst_inst_mag_r_2 = [phot_r_2['mag'][2], phot_r_2['mag'][3]]
lijst_inst_mag_r_1 = [phot_r_1['mag'][7], phot_r_1['mag'][8]]
...
plt.savefig('fit_overbelicht.png')
